...
### **Paradigma Estruturado ou Procedural (ou Procedimental):**

Foca no **"como fazer"**. Baseia-se em três estruturas: **sequência**, **decisão** e **iteração**.

O problema principal é a **Lacuna Semântica**, ou seja, a dificuldade de **representar a realidade de forma direta**, pois **dados** e **operações** ficam **desassociados** no código.
